...
% --- Controlador PID (discreto, mismo Ts que la planta) ---
add_block('simulink/Discrete/Discrete PID Controller', modelName + "/PID", ...
    'P', '0.3', 'I', '0.05', 'D', '0', 'SampleTime', num2str(Ts), ...
